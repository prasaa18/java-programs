...
String insertQuery="insert into usersdb.user values ("+0+","+"'"+name+"'"+","+"'"+email+"'"+","+"'"+password+"'"+","+"'"+mob+"'"+");";
		...
		{
	    	Statement stmt;
			stmt = db.con.createStatement();//Creates a Statement object for sending SQL statements to the database.
		    stmt.executeUpdate(insertQuery);//save the data
	 ...
	 public void updateProfile()
		{
		   ...
		   //connect to db
		   db.connect(); 	
		   String updateQuery ="update usersdb.user set email="+"'"+newEmail+"'"+"where email="+"'"+oldEmail+"';";
		    try
			{
		    	Statement stmt;
				stmt = db.con.createStatement();//Creates a Statement object for sending SQL statements to the database.
			    stmt.executeUpdate(updateQuery);//save the data
	 ...
	 public void deleteProfile()
		{
		 System.out.println("please enter your old email id");
		  ...
		  //connect to db
		  db.connect(); 	
		  String deleteQuery = "delete from usersdb.user where email="+"'"+Email+"';";
		  try
			{
		    	Statement stmt;
				stmt = db.con.createStatement();//Creates a Statement object for sending SQL statements to the database.
	...
	//viewProfile
		public void viewProfile()
		{
		  ...
		  String selectQuery = "select*from usersdb.user where email="+"'"+emailID+"';";
		  try 
			{
		    	Statement stmt;
